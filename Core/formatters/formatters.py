...
--------
  ...
  format_information     -- combined district + field office + silly meter embeds
...
# Faction colors
FACTION_COLORS = {
    "Sellbot":  0xE74C3C,  # Red
    "Cashbot":  0x1ABC9C,  # Teal
    "Lawbot":   0x9B59B6,  # Purple
    "Bossbot":  0x2ECC71,  # Green
}
...
def format_field_offices_embed(
    *,
    ...
    """Embed 2 of 3: active field offices."""
...
def format_information(
    *,
    ...
    """Return [districts_embed, field_offices_embed] for information feed."""
    return [
...
def format_sillymeter(data: dict[str, Any] | None) -> discord.Embed:
    """Embed for the sillymeter feed showing Silly Meter status."""
...
FORMATTERS = {
    ...
    "sillymeter": lambda d: [format_sillymeter(d.get("sillymeter"))],
}
