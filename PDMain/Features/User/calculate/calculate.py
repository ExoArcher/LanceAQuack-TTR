...
class _PointsModal(discord.ui.Modal):
    """Modal for entering current points and generating result."""
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        ...
        embed = build_result_embed(
            self.suit_name, self.faction, self.level_num, current_pts, self.quota, self.is_v2, options
        )
